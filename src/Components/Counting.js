    ...
    return (
        ...
        <div className="counting">
            ...
            <div>
              ...
              <button className="btn-3" onClick = {() => setCountS(current => ({ ...current, count1: 0}))}>reset</button> {/** to merge our obj we add the ...current obj spread so then count1 is overriden and count2 is preserved */}
            </div>
